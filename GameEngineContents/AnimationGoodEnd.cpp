...
void StreamAnimation::UpdateD1()
{
	...
	{
		Renderer->ChangeFrameAnimation("cho_kashikoma"); // ¿À¸¥¼Õ ºêÀÌ 
		AnimationStart = true;
	}
...
void StreamAnimation::UpdateD3()
{
	...
	if (AnimationStart == false)
	{
		Renderer->ChangeFrameAnimation("cho_idleEnd"); // ¾çº¼ °¨½Î±â + À®Å©?
		AnimationStart = true;
	}
...
void StreamAnimation::UpdateD4()
{
	...
	if (AnimationStart == false)
	{
		Renderer->ChangeFrameAnimation("cho_idleEnd"); // ¾çº¼ °¨½Î±â, ´«°¨±â
		AnimationStart = true;
	}
...
void StreamAnimation::UpdateD7()
{
	...
	if (AnimationStart == false)
	{
		Renderer->ChangeFrameAnimation("cho_idleEnd"); // ´«°¨°í ¾ç¼Õ ³»¹Ð°í Èçµé±â
		AnimationStart = true;
	}
...
void StreamAnimation::UpdateD8()
{
	...
	if (AnimationStart == false)
	{
		Renderer->ChangeFrameAnimation("cho_idleEnd"); // ÇÑ¼Õ ³»¹Ð¸ç ºêÀÌ
		AnimationStart = true;
	}
...
void StreamAnimation::UpdateD10()
{
	...
	if (AnimationStart == false)
	{
		Renderer->ChangeFrameAnimation("cho_idleEnd"); // Çã°ø Å°½º
		AnimationStart = true;
	}
