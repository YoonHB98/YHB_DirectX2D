...
int GlobalContentsValue::Followers = 1;
...
float GlobalContentsValue::BgmSpeed =1.0f;
...
bool GlobalContentsValue::DayChangeWindow = false;
...
std::string GlobalContentsValue::Stream_Window = "";
