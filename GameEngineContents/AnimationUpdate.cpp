...
void StreamAnimation::StateUpdate(AnimationType Type)
{
	...
	case AnimationType::B7:
		UpdateB7();
		break;
	case AnimationType::C1:
		UpdateC1();
		break;
	case AnimationType::C2:
		UpdateC2();
		break;
	case AnimationType::C3:
		UpdateC3();
		break;
	case AnimationType::D1:
		UpdateD1();
		break;
	case AnimationType::D2:
		UpdateD2();
		break;
	case AnimationType::D3:
		UpdateD3();
		break;
	case AnimationType::D4:
		UpdateD4();
		break;
	case AnimationType::D5:
		UpdateD5();
		break;
	case AnimationType::D6:
		UpdateD6();
		break;
	case AnimationType::D7:
		UpdateD7();
		break;
	case AnimationType::D8:
		UpdateD8();
		break;
	case AnimationType::D9:
		UpdateD9();
		break;
...
{
	TextDrawTime("젤하!", "Galmuri9", float4(332, 306), float4(222 / 255, 215 / 255, 1), 15.0f, 0.5f);
